...
@WebServlet(name = "PayAdmin", urlPatterns = {"/admin/PayAdmin"})
public class PayAdmin extends HttpServlet {
...
//        User user = (User) request.getSession().getAttribute("LoginUser");
        ...
        boolean checkOrder = payment.startPaymentAdmin(user_id, productCart, order);
