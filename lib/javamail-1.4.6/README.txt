	    ...
	    JavaMail(TM) API 1.4.6 release
	    ------------------------------

Welcome to the JavaMail API 1.4.6 release!  This release includes
...
------------
  ...
  2. Set your CLASSPATH to include the "mail.jar" file obtained from 
     ...
     Assuming you unzipped javamail1_4_6.zip in c:\download the
     following would work:
